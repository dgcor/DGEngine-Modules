...
export class ActVariableClear : public Action
{
private:
	std::string key;
...
export class ActVariableSave : public Action
{
private:
	std::string filePath;
...
export class ActVariableSet : public Action
{
private:
	std::string key;
	Variable val;
...
export class ActVariableSetIfNull : public Action
{
private:
	std::string key;
	Variable val;
...
export class ActVariablesSet : public Action
{
private:
