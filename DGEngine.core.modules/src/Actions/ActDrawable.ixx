...
export class ActDrawableAddToSize : public Action
{
private:
	std::string id;
	sf::Vector2f offset;
...
export class ActDrawableAnchor : public Action
{
private:
	std::string id;
	std::string idAnchor;
...
export class ActDrawableAnchorSizeXY : public Action
{
private:
	std::string id;
...
export class ActDrawableAnchorToFocused : public Action
{
private:
	std::string id;
	Anchor anchor;
...
export class ActDrawableBringToFront : public Action
{
private:
	std::string id;
...
export class ActDrawableCenter : public Action
{
private:
	std::string id;
...
export class ActDrawableCenterOnMouseX : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableCenterOnMouseY : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableDelete : public Action
{
private:
	std::string id;
...
export class ActDrawableExecuteAction : public Action
{
private:
	std::string id;
...
export class ActDrawableHorizontalAnchorToFocused : public Action
{
private:
	std::string id;
	float offset;
...
export class ActDrawableMoveX : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableMoveY : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableMoveStepX : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableMoveStepY : public Action
{
private:
	std::string id;
	std::string idAnchorTo;
...
export class ActDrawableResizeXY : public Action
{
private:
	std::string id;
	Variable size;
...
export class ActDrawableResizeOnMouseX : public Action
{
private:
	std::string id;
	sf::Vector2f range;
...
export class ActDrawableResizeOnMouseY : public Action
{
private:
	std::string id;
	sf::Vector2f range;
...
export class ActDrawableResizeToPositionX : public Action
{
private:
	std::string id;
...
export class ActDrawableResizeToPositionY : public Action
{
private:
	std::string id;
	std::string idToPosition;
...
export class ActDrawableSetAction : public Action
{
private:
	std::string id;
	uint16_t nameHash;
...
export class ActDrawableSendToBack : public Action
{
private:
	std::string id;
...
export class ActDrawableSetPosition : public Action
{
private:
	std::string id;
	sf::Vector2f pos;
...
export class ActDrawableSetPositionXY : public Action
{
private:
	std::string id;
	float pos;
...
export class ActDrawableSetSize : public Action
{
private:
	std::string id;
	sf::Vector2f size;
...
export class ActDrawableSetSizeXY : public Action
{
private:
	std::string id;
	float size;
...
export class ActDrawableVerticalAnchorToFocused : public Action
{
private:
	std::string id;
	float offset;
