...
export class ActCursorEnableOutline : public Action
{
private:
	bool enable;
...
export class ActCursorPop : public Action
{
private:
	bool popAll;
...
export class ActCursorSetColor : public Action
{
private:
	sf::Color color;
...
export class ActCursorSetOutline : public Action
{
private:
	sf::Color outline;
	sf::Color ignore;
...
export class ActCursorSetPalette : public Action
{
private:
...
export class ActCursorSetPosition : public Action
{
private:
	sf::Vector2i pos;
...
export class ActCursorShow : public Action
{
private:
	bool show;
