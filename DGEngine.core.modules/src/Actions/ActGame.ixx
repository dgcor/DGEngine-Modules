...
export class ActGameClearPlayingSounds : public Action
{
public:
...
export class ActGameClose : public Action
{
public:
	bool execute(Game& game) override
	{
...
export class ActGameDraw : public Action
{
public:
	bool execute(Game& game) override
	{
...
export class ActGameEnableInput : public Action
{
private:
	bool enable;
...
export class ActGameLoad : public Action
{
private:
	std::string file;
	std::string mainFile;
...
export class ActGamePauseOnFocusLoss : public Action
{
private:
	bool pause;
...
export class ActGameSetGamma : public Action
{
private:
	Variable gamma;
...
export class ActGameSetMusicVolume : public Action
{
private:
	Variable volume;
...
export class ActGameSetProperty : public Action
{
private:
	std::string prop;
	Variable value;
...
export class ActGameSetSoundVolume : public Action
{
private:
	Variable volume;
