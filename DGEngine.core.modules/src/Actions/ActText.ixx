...
export class ActTextSetColor : public Action
{
private:
	std::string id;
	sf::Color color;
...
export class ActTextSetFont : public Action
{
private:
	std::string id;
	std::string idFont;
...
export class ActTextSetSpacing : public Action
{
private:
	std::string id;
...
export class ActTextSetText : public Action
{
private:
	std::string id;
	std::string textFormat;
