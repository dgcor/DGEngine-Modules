...
export class ActMenuClick : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuClickVisible : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuMoveScrollbar : public Action
{
private:
	std::string idMenu;
...
export class ActMenuRightClick : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuRightClickVisible : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuSetColor : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuSetFont : public Action
{
private:
	std::string id;
	size_t idx;
...
export class ActMenuSetIndex : public Action
{
private:
	std::string id;
	Variable idxVar;
...
export class ActMenuSetText : public Action
{
private:
	std::string id;
	size_t idx;
