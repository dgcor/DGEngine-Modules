...
export class ActDirCreate : public Action
{
private:
	std::string dir;
...
export class ActFileCopy : public Action
{
private:
	std::string dir;
...
export class ActIODelete : public Action
{
private:
	std::string dir;
...
export class ActIODeleteAll : public Action
{
private:
	std::string dir;
	bool deleteRoot;
