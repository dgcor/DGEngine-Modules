...
export class ActImageInverseResizeXY : public Action
{
private:
	std::string id;
	Variable size;
...
export class ActImageSetOutline : public Action
{
private:
	std::string id;
	sf::Color outline;
...
export class ActImageSetPalette : public Action
{
private:
	std::string id;
...
export class ActImageSetTexture : public Action
{
private:
	std::string id;
...
export class ActImageSetTextureFromPack : public Action
{
private:
	std::string id;
...
export class ActImageSetTextureFromQueryable : public Action
{
private:
	std::string id;
	std::string query;
...
export class ActImageSetTextureRect : public Action
{
private:
	std::string id;
	sf::IntRect rect;
