...
export module dgengine.actions.animation;

import dgengine.actions.action;
import dgengine.animation;
import dgengine.game;

export class ActAnimationPause : public Action
{
private:
	std::string id;
	bool pause;
...
export class ActAnimationSetAnimation : public Action
{
private:
	std::string id;
...
export class ActAnimationSetRefresh : public Action
{
private:
	std::string id;
	sf::Time refresh;
