...
namespace Parser
{
	...
	std::shared_ptr<Circle> getCircleObj(Game& game, const Value& elem)
	{
		...
		circle->setFillColor(getColorKey(elem, "color", sf::StaticColor::White()));
		circle->setOutlineColor(getColorKey(elem, "outlineColor", sf::StaticColor::White()));
