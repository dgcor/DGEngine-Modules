...
import dgengine.parser.audio;
import dgengine.parser.button;
import dgengine.parser.circle;
import dgengine.parser.cursor;
import dgengine.parser.event;
import dgengine.parser.filebytes;
import dgengine.parser.font;
import dgengine.parser.icon;
import dgengine.parser.image;
import dgengine.parser.imagecontainer;
import dgengine.parser.inputevent;
import dgengine.parser.inputtext;
import dgengine.parser.loadingscreen;
import dgengine.parser.menu;
import dgengine.parser.mountfile;
import dgengine.parser.movie;
import dgengine.parser.palette;
import dgengine.parser.panel;
import dgengine.parser.rectangle;
import dgengine.parser.scrollable;
import dgengine.parser.shader;
import dgengine.parser.shape;
import dgengine.parser.sound;
import dgengine.parser.text;
import dgengine.parser.texture;
import dgengine.parser.texturepack;
