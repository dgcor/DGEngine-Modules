...
export
{
	...
	constexpr uint16_t str2int16(const std::string& str) noexcept
	{
	...
	constexpr uint32_t str2int32(const std::string& str) noexcept
	{
		return char2intT<uint32_t>(str.data(), str.size());
	}

	constexpr uint32_t str2int32(const std::string_view str) noexcept
	{
		return char2intT<uint32_t>(str.data(), str.size());
	}
}
...
export namespace Utils
{
	...
	template<class T>
	constexpr T str2intT(const std::string& str) noexcept
	{
		return char2intT<T>(str.data(), str.size());
	}

	template<class T>
	constexpr T str2intT(const std::string_view str) noexcept
	{
		return char2intT<T>(str.data(), str.size());
	}
